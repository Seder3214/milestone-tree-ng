addLayer("ep", {
	...
	buyables: {
		...
		11:{
			...
			cost(){
				return [new Decimal("2"),new Decimal("8"),new Decimal("512"),new Decimal("1e55"),new Decimal("1e170"), new Decimal('1e2000'),new Decimal('1e4500'),new Decimal('1e3330000'),Decimal.dInf][player.ep.buyables[11]]
			},
			canAfford() {
