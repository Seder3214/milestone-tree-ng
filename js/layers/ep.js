addLayer("ep", {
    ...
    gainMult() { // Calculate the multiplier for main currency from bonuses
		...
		if (player.mp.buyables[11].gte(1)) mult = mult.mul(buyableEffect('mp',11))
        return mult
    },
	...
	upgrades: {
		...
		13: {
            ...
            unlocked() { return player.mp.buyables[21].gte(1)},
			effect() { // Calculate bonuses from the upgrade. Can return a single value or an object with multiple values
		...
		14: {
            ...
            unlocked() { return player.mp.buyables[21].gte(2)},
        },
		21: {
	...
	buyables: {
		...
		11:{
			...
			cost(){
				return [new Decimal("2"),new Decimal("8"),new Decimal("512"),new Decimal("1e55"),new Decimal("1e170"), new Decimal('1e2000'),new Decimal('1e150000'),new Decimal('e3330000')][player.ep.buyables[11]]
			},
			canAfford() {
