var systemComponents = {
	...
	'layer-tab': {
		...
		template: `
		<div style="	-moz-transform: scale(-1, 1);
		-webkit-transform: scale(-1, 1);
		transform: scale(-1, 1);" v-bind:style="[tmp[layer].style ? tmp[layer].style : {}, (tmp[layer].tabFormat && !Array.isArray(tmp[layer].tabFormat)) ? tmp[layer].tabFormat[player.subtabs[layer].mainTabs].style : {}, options.forceOneTab==true?{'margin-left':'350px'}:{}]" class="noBackground">
