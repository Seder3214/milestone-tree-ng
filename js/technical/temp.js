...
var activeFunctions = [
	...
	"getUnlocked", "getStyle", "getCanClick", "getTitle", "getDisplay",'getCost','getEffect','getEssence','getTooltip','getTooltipStyle','activeCorruptions',"getMark","fetchTimer"
]
...
function updateTemp() {
	if (player.cp.chosenBackdoor==0) player.cp.chosenBackdoor=undefined
	if (player.cp.trojanChosen==null) player.cp.trojanChosen=undefined
